...
class TenantDocumentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                'id_section' => 7,
                'nama_file' => 'Surat Karantina',
                'attribute' => 1,
                'link_path_example_file' => 'documents/examples/surat_karantina.pdf',
                'link_path_template_file' => 'documents/templates/surat_karantina.pdf',
                'link_url_video_file' => 'https://www.youtube.com/watch?v=28whxoWAzA0',
                'description_file' => 'Dokumen resmi karantina untuk pengecekan barang.',
                'updated_by' => 1,
                'is_internal' => false,
                'is_verification' => true,
                'created_at' => $now,
