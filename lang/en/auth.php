...
return [
    ...
    */
    ...
    'label_name' => 'Name Account',
    'placeholder_name' => 'Enter name account user',
    'label_email' => 'Email Account',
    'placeholder_email' => 'Enter email account user',
    'label_password' => 'Password Account',
    'placeholder_password' => 'Enter password account user',
    'label_password_confirm' => 'Confirm Password Account',
    'placeholder_password_confirm' => 'Confirm password account user',
    
    'label_company' => 'Company',
    'placeholder_company' => 'Select company',
    'no_data_company' => 'No company data',
    
    'label_user_type' => 'Type User',
