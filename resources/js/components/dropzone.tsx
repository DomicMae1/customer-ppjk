...
const DropzoneDescription = forwardRef<HTMLParagraphElement, DropzoneDescriptionProps>((props, ref) => {
    ...
    return <p ref={ref} id={context.rootDescriptionId} {...rest} className={cn('text-muted-foreground pb-1 text-sm', className)} />;
});
    ...
    return (
        ...
        >
            <li
                ...
                className={cn('bg-muted/40 flex flex-col justify-center gap-2 rounded-md px-4 py-2', className)}
            >
                {props.children}
            </li>
        </DropzoneFileListContext.Provider>
...
const DropzoneFileMessage = forwardRef<HTMLParagraphElement, DropzoneFileMessageProps>((props, ref) => {
    ...
    return (
        <p ref={ref} id={context.messageId} {...rest} className={cn('text-destructive h-5 text-[0.8rem] font-medium', rest.className)}>
            {body}
        </p>
    );
});
...
const DropzoneMessage = forwardRef<HTMLParagraphElement, DropzoneMessageProps>((props, ref) => {
    ...
    return (
        <p ref={ref} id={context.rootMessageId} {...rest} className={cn('text-destructive h-5 text-[0.8rem] font-medium', rest.className)}>
            {body}
        </p>
    );
});
